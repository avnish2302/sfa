...
export default function PunchIn() {
  ...
  const mutation = useMutation({
    // tanstack/react query mutation : handle API requests that modify server data
    mutationFn: punchIn,
    onSuccess: () => {
      // server returns success -> toast notification -> refresh punch summary -> reset form -> redirect to checkin. refresh because sidebar and navbar depend on punch status
